...
const AuthButtons = () => {
  return (
    <div className="flex justify-center flex " style={{ transform: "translateY(-200px)" }}>
      <button
      ...
      >
        <i className="fab fa-facebook text-3xl"></i> Đăng nhập bằng Facebook
      </button>
      <button
      ...
      >
        <i className="fab fa-google text-3xl"></i> Đăng nhập bằng Google
      </button>
    </div>
  );
};
