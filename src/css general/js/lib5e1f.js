...
let GetQRPaymentCode = {
    load: function (bankId,bankAccountNumber,bankAccountHolder,generatedPaymentCode,amount,resultContainer) {
        AppAjax.post(
            '/order/bankqrcode',  {
                'bankId': bankId,
            ...
            function (rs) {
               if(rs.code === 1){
                   resultContainer.empty().append('<img src="'+rs.image+'" alt="QR" width="300">');
               }
            },
            'json'
        );
